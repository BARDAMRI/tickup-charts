...
const Ji = reactExports.forwardRef(({ intervalsArray: A2, visibleRange: e2, setVisibleRange: a2, visiblePriceRange: Q2, drawings: g2, setDrawings: E2, selectedIndex: d2, setSelectedIndex: I2, onRequestShapeProperties: u2, chartOptions: f2, canvasSizes: h2, parentContainerRef: m2, windowSpread: b2, showBrandWatermark: w2 = true, isPrimeLicensed: y2 = false, brandTheme: P2 = ft.light }, V2) => {
  var x2, z2, X2, M2;
  const { mode: O2, setMode: q2 } = p(), H2 = reactExports.useRef(null), W2 = reactExports.useRef(null), D2 = reactExports.useRef(null), F2 = reactExports.useRef(null), j2 = reactExports.useRef(null), T2 = reactExports.useRef(null), N2 = reactExports.useRef(null), K2 = reactExports.useRef(null), Y2 = reactExports.useRef(0), G2 = reactExports.useRef(void 0);
  reactExports.useRef(null);
  const [k2, U2] = reactExports.useState(false), [Z2, L2] = reactExports.useState(false), [R2, S2] = reactExports.useState(null), [J2, $2] = reactExports.useState(null), _2 = reactExports.useRef(null), AA2 = reactExports.useRef(1), [eA2, tA2] = i.useState(null), nA2 = i.useRef(null), rA2 = reactExports.useRef(null), [iA2, aA2] = reactExports.useState(0), BA2 = O2 === v.none || O2 === v.select || O2 === v.editShape, QA2 = O2 === v.none, { renderContext: oA2, intervalSeconds: gA2 } = function(A3, e3, t2, n2, r2, i2) {
    const a3 = reactExports.useMemo(() => e3 ? A3 : A3.slice(-2e3), [A3, e3]), B2 = reactExports.useMemo(() => an(a3, 3600), [a3]), Q3 = reactExports.useMemo(() => {
      const A4 = a3.length;
      if (!A4 || B2 <= 0 || null == t2) return { startIndex: 0, endIndex: 0 };
      const { start: e4, end: n3 } = t2;
      if (null == e4 || null == n3) return { startIndex: 0, endIndex: 0 };
      const r3 = t2.startIndex, i3 = t2.endIndex;
      if ("number" == typeof r3 && "number" == typeof i3 && r3 >= 0 && i3 >= 0 && r3 <= i3 && r3 < A4 && i3 < A4) return { startIndex: r3, endIndex: i3 };
      const Q4 = a3[0].t, o3 = Math.floor((e4 - Q4) / B2), g3 = Math.ceil((n3 - Q4) / B2);
      return { startIndex: Math.max(0, o3), endIndex: Math.min(A4 - 1, g3) };
    }, [a3, B2, t2.start, t2.end, t2.startIndex, t2.endIndex]), o2 = (() => {
      const { startIndex: A4, endIndex: e4 } = Q3;
      if (A4 >= e4 || !a3.length) return { min: 0, max: 100, range: 100 };
      let t3 = 1 / 0, n3 = -1 / 0;
      ...
      const r3 = 0.1 * Math.max(0, n3 - t3), i3 = t3 - r3, B3 = n3 + r3;
      return { min: i3, max: B3, range: B3 - i3 };
    })();
    return { renderContext: reactExports.useMemo(() => 0 === r2 || 0 === i2 ? null : { allIntervals: a3, visibleStartIndex: Q3.startIndex, visibleEndIndex: Q3.endIndex, visiblePriceRange: o2, visibleRange: t2, intervalSeconds: B2, canvasWidth: r2, canvasHeight: i2 }, [a3, Q3.startIndex, Q3.endIndex, o2.min, o2.max, o2.range, t2, B2, r2, i2]), intervalSeconds: B2 };
  }(A2, y2, e2, 0, h2.width, h2.height), EA2 = reactExports.useCallback(() => {
    O2 !== v.none && O2 !== v.select && O2 !== v.editShape ? (_2.current = function(A3) {
      let e3;
      const t2 = nn();
      switch (A3.mode) {
        case v.drawLine:
      ...
      return e3;
    }({ mode: O2, args: void 0, style: f2.base.style.drawings }), O2 === v.drawAngle && (AA2.current = 1)) : _2.current = null;
  }, [O2, f2.base.style.drawings]);
  reactExports.useEffect(() => {
    O2 !== v.drawAngle && (AA2.current = 1);
    ...
    nA2.current = n2, tA2(n2);
  }, [null == h2 ? void 0 : h2.width, null == h2 ? void 0 : h2.height]), reactExports.useEffect(() => {
    const A3 = (A4) => {
      var e3;
      "Escape" === A4.key && (O2 === v.drawPolyline && (null == (e3 = _2.current) || e3.setPoints([])), O2 !== v.none && O2 !== v.select && O2 !== v.editShape && q2(v.none));
    };
  ...
  const sA2 = reactExports.useCallback((A3, e3, t2) => {
    ...
    if (j2.current.width === B2 && j2.current.height === o2 || (j2.current.width = B2, j2.current.height = o2), A3.setTransform(a3, 0, 0, a3, 0, 0), A3.clearRect(0, 0, r2, i2), function(A4, e4, t3, n3) {
      ...
      }(A3, r2, i2, P2, rA2.current, function(A4, e5) {
  ...
  }, [f2, Q2, w2, P2]), lA2 = reactExports.useCallback((A3, e3) => {
    const { cssWidth: t2, cssHeight: n2, dpr: r2, width: i2, height: a3 } = A3, B2 = H2.current, Q3 = j2.current;
    if (B2 && Q3) {
    ...
    const { dpr: n2, cssWidth: r2, cssHeight: i2 } = e3, a3 = D2.current;
  ...
  }, [f2, w2, P2]), CA2 = reactExports.useCallback((A3, e3) => {
    var t2, n2, r2, i2;
    const { dpr: a3, cssWidth: B2, cssHeight: Q3 } = A3, o2 = D2.current, g3 = T2.current;
  ...
  }, [D2, T2, null == (x2 = null == f2 ? void 0 : f2.base) ? void 0 : x2.showHistogram, null == (M2 = null == (X2 = null == (z2 = null == f2 ? void 0 : f2.base) ? void 0 : z2.style) ? void 0 : X2.histogram) ? void 0 : M2.heightRatio]), cA2 = reactExports.useCallback((A3, e3) => {
    const { cssWidth: t2, cssHeight: n2, dpr: r2, width: i2, height: a3 } = A3, B2 = F2.current, Q3 = N2.current;
    if (B2 && Q3) {
      const A4 = B2.getContext("2d");
    ...
    var e3;
    const { cssWidth: t2, cssHeight: n2, dpr: r2 } = A3, i2 = W2.current, a3 = G2.current;
    if (!oA2 || !i2) return;
    ...
    if (B2) {
      ...
      if (A4 && BA2 && a3 && !k2 && !Z2) {
        ...
        if (B2.restore(), o2 && oA2) {
          const A6 = f2.base.style.axes, e4 = Dt(a3.x, oA2.canvasWidth, oA2.visibleRange), r3 = Ft(a3.y, oA2.canvasHeight, Q2), i3 = t2 < 540, o3 = Mi.formatDateForInterval(new Date(1e3 * e4), A6, gA2, i3), g3 = Mi.formatPrice(r3, A6), E3 = A6.font || "12px system-ui, sans-serif";
          B2.font = E3;
      ...
      } else _2.current && oA2 && bn(B2, [_2.current], d2, oA2, Q2);
    }
  }, [W2, G2, O2, k2, Z2, d2, bn, oA2, Q2, f2]), uA2 = reactExports.useCallback(() => {
    if (!oA2) return;
    const A3 = nA2.current;
    if (!A3) return;
    j2.current || (j2.current = document.createElement("canvas"));
    const e3 = j2.current.getContext("2d");
    e3 && (sA2(e3, A3, oA2), dA2(T2, A3, oA2), ((A4, e4, t2) => {
  ...
  const fA2 = reactExports.useCallback(() => {
    K2.current = null;
    const A3 = Y2.current, e3 = nA2.current;
    e3 && (lA2(e3, A3), CA2(e3, A3), cA2(e3, A3), IA2(e3));
  }, [k2, Z2, O2, lA2, CA2, cA2, IA2]), vA2 = reactExports.useCallback(() => {
    K2.current || (K2.current = window.requestAnimationFrame(fA2));
  }, [fA2]);
  reactExports.useEffect(() => (oA2 && (uA2(), vA2()), () => {
    K2.current && ("number" == typeof K2.current && window.cancelAnimationFrame(K2.current), K2.current = null);
  }), [oA2, uA2, vA2]), reactExports.useEffect(() => {
    if (oA2) return uA2(), vA2(), () => {
      K2.current && ("number" == typeof K2.current && window.cancelAnimationFrame(K2.current), K2.current = null);
    };
  }, [Q2, oA2, uA2, vA2]);
  ...
  }(W2, QA2, A2, e2, a2, gA2, hA2, () => h2.width);
  const mA2 = (e3) => {
    var t2, n2;
    const r2 = e3.currentTarget.getBoundingClientRect(), i2 = { x: e3.clientX - r2.left, y: e3.clientY - r2.top };
    if (G2.current = i2, O2 !== v.none && O2 !== v.select && O2 !== v.editShape && O2 !== v.drawPolyline && _2.current && oA2 && ((null == (t2 = _2.current) ? void 0 : t2.points.length) ?? 0) > 0) {
      const A3 = { time: Dt(i2.x, oA2.canvasWidth, oA2.visibleRange), price: Ft(i2.y, oA2.canvasHeight, Q2) };
      Si(_2.current, oA2, Q2), O2 === v.drawAngle && _2.current instanceof mn && 2 === AA2.current ? _2.current.updateSecondRayEnd(A3) : null == (n2 = _2.current) || n2.updateLastPoint(A3);
    }
    if (oA2) {
      const e4 = Dt(i2.x, oA2.canvasWidth, oA2.visibleRange), t3 = A2.find((A3) => e4 >= A3.t && e4 < A3.t + gA2);
      (null == t3 ? void 0 : t3.t) !== (null == J2 ? void 0 : J2.t) && $2(t3 || null);
    }
    vA2();
  };
  return reactExports.useImperativeHandle(V2, () => ({ getCanvasSize() {
    const A3 = nA2.current;
  ...
  }, getMainCanvasElement: () => H2.current, clearCanvas() {
    ...
    if (null == N2 ? void 0 : N2.current) {
      const A3 = N2.current.getContext("2d");
      A3 && A3.clearRect(0, 0, N2.current.width, N2.current.height);
    }
  }, redrawCanvas() {
    vA2();
  } }), [vA2]), jsxRuntimeExports.jsxs(pt, { className: "inner-canvas-container", $xAxisHeight: b2.INITIAL_X_AXIS_HEIGHT, ref: m2, children: [jsxRuntimeExports.jsxs(bt, { className: "charting-container", children: [jsxRuntimeExports.jsx(ht, { className: "chart-data-canvas", ref: H2, $zIndex: 1, $heightPrecent: 100 }), f2.base.showHistogram && jsxRuntimeExports.jsx(ht, { className: "histogram-canvas", ref: D2, $heightPrecent: Math.round(100 * Math.max(0.1, Math.min(0.6, f2.base.style.histogram.heightRatio))), $zIndex: 2, style: { opacity: f2.base.style.histogram.opacity } }), jsxRuntimeExports.jsx(ht, { className: "drawings-canvas", ref: F2, $heightPrecent: 100, $zIndex: 3 }), jsxRuntimeExports.jsx(mt, { className: "drawing-interaction-canvas", ref: W2, onMouseMove: mA2, onMouseLeave: () => {
    G2.current = void 0, S2(null), $2(null), vA2();
  }, onMouseEnter: mA2, onMouseDown: (A3) => {
    var e3, t2, n2, r2;
    if (!oA2) return;
    if (!nA2.current) return;
    const i2 = A3.currentTarget.getBoundingClientRect(), a3 = A3.clientX - i2.left, B2 = A3.clientY - i2.top;
    if ((O2 === v.select || O2 === v.editShape) && I2) {
      for (let A4 = g2.length - 1; A4 >= 0; A4--) {
        const e4 = g2[A4];
        if (null == e4 ? void 0 : e4.isHit(a3, B2, oA2, Q2)) return void I2(A4);
      }
      return void I2(null);
    }
    if (BA2) return;
    const o2 = { time: Dt(a3, oA2.canvasWidth, oA2.visibleRange), price: Ft(B2, oA2.canvasHeight, Q2) };
    O2 === v.drawAngle && 2 === AA2.current || (O2 !== v.drawPolyline || (null == (e3 = _2.current) ? void 0 : e3.points.length) >= 1 ? (null == (t2 = _2.current) || t2.setFirstPoint(o2), Si(_2.current, oA2, Q2)) : O2 === v.drawPolyline && 1 === (null == (n2 = _2.current) ? void 0 : n2.points.length) && (null == (r2 = _2.current) || r2.addPoint(o2)));
  }, onMouseUp: () => {
    var A3;
    if (!_2.current || !G2.current || !oA2 || O2 === v.drawPolyline) return;
    const e3 = { time: Dt(G2.current.x, oA2.canvasWidth, oA2.visibleRange), price: Ft(G2.current.y, oA2.canvasHeight, Q2) };
    if (Si(_2.current, oA2, Q2), O2 === v.drawAngle && _2.current instanceof mn) {
      const A4 = _2.current;
      if (1 === AA2.current) {
        if (A4.updateLastPoint(e3), A4.getPoints().length < 2) return;
        return AA2.current = 2, void vA2();
      }
      if (A4.updateSecondRayEnd(e3), A4.getPoints().length < 3) return;
      return E2((e4) => [...e4, A4]), void EA2();
    }
    null == (A3 = _2.current) || A3.updateLastPoint(e3);
    const t2 = _2.current;
    ...
    QA2 || (A3.preventDefault(), A3.stopPropagation());
  }, onDoubleClick: (A3) => {
    if (!oA2) return;
    const e3 = A3.currentTarget.getBoundingClientRect(), t2 = A3.clientX - e3.left, n2 = A3.clientY - e3.top;
    if (O2 === v.drawPolyline && _2.current && G2.current) {
      const A4 = _2.current;
      return E2((e4) => [...e4, A4]), void EA2();
    }
    if ((O2 === v.none || O2 === v.select || O2 === v.editShape) && u2) for (let e4 = g2.length - 1; e4 >= 0; e4--) {
      const r2 = g2[e4];
      if (null == r2 ? void 0 : r2.isHit(t2, n2, oA2, Q2)) return null == I2 || I2(e4), u2(e4), void A3.preventDefault();
    }
  }, onContextMenu: (A3) => {
    if (null == d2 || !u2 || !oA2 || d2 < 0 || d2 >= g2.length) return;
    const e3 = A3.currentTarget.getBoundingClientRect(), t2 = A3.clientX - e3.left, n2 = A3.clientY - e3.top, r2 = g2[d2];
    (null == r2 ? void 0 : r2.isHit(t2, n2, oA2, Q2)) && (A3.preventDefault(), u2(d2));
  }, $heightPrecent: 100, $zIndex: 4, style: { cursor: QA2 ? k2 ? "grabbing" : "grab" : O2 === v.select || O2 === v.editShape ? "default" : "crosshair", backgroundColor: "transparent" } })] }), f2.base.showCandleTooltip && J2 && !k2 && !O2 && !Z2 && jsxRuntimeExports.jsx(wt, { className: "intervals-data-tooltip", $isPositive: J2.c > J2.o, $isRTL: "rtl" === ti(f2.base.style.axes.locale).direction, $variant: f2.base.theme === ft.dark || f2.base.theme === ft.grey ? ft.dark : ft.light, $compact: h2.width < 440 || h2.height < 280, title: (() => {
    const A3 = f2.base.style.axes, e3 = A3.language || "en", t2 = J2, n2 = h2.width < 440 || h2.height < 280, r2 = [Mi.formatDateForInterval(new Date(1e3 * t2.t), A3, gA2, n2), `${ri("open", e3)} ${Mi.formatPrice(t2.o, A3)}`, `${ri("high", e3)} ${Mi.formatPrice(t2.h, A3)}`, `${ri("low", e3)} ${Mi.formatPrice(t2.l, A3)}`, `${ri("close", e3)} ${Mi.formatPrice(t2.c, A3)}`];
    return void 0 !== t2.v && r2.push(`${ri("volume", e3)} ${Mi.formatPrice(t2.v, { ...A3, numberNotation: xt.compact })}`), r2.join(" · ");
  })(), children: (() => {
    const A3 = f2.base.style.axes, e3 = A3.language || "en", i2 = f2.base.theme, a3 = i2 === ft.dark || i2 === ft.grey, B2 = J2.c - J2.o, Q3 = B2 / J2.o, o2 = a3 ? B2 >= 0 ? "#7ee2b8" : "#ff9e9e" : B2 >= 0 ? "green" : "red", g3 = h2.width < 440 || h2.height < 280, E3 = Mi.formatDateForInterval(new Date(1e3 * J2.t), A3, gA2, g3), s2 = g3 ? { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2px 8px", alignItems: "baseline", width: "100%" } : { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 12px", alignItems: "baseline", width: "100%" };
    return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx("div", { style: { fontWeight: "bold", borderBottom: a3 ? "1px solid rgba(255,255,255,0.14)" : "1px solid rgba(0,0,0,0.1)", marginBottom: g3 ? 2 : 4, paddingBottom: 2 }, children: E3 }), jsxRuntimeExports.jsxs("div", { style: s2, children: [jsxRuntimeExports.jsxs("span", { children: [ri("open", e3), ": ", Mi.formatPrice(J2.o, A3)] }), jsxRuntimeExports.jsxs("span", { children: [ri("high", e3), ": ", Mi.formatPrice(J2.h, A3)] }), jsxRuntimeExports.jsxs("span", { children: [ri("low", e3), ": ", Mi.formatPrice(J2.l, A3)] }), jsxRuntimeExports.jsxs("span", { children: [ri("close", e3), ": ", Mi.formatPrice(J2.c, A3)] })] }), jsxRuntimeExports.jsxs("div", { style: { marginTop: g3 ? 2 : 4 }, children: [ri("change", e3), ":", " ", jsxRuntimeExports.jsxs("span", { style: { color: o2, fontWeight: "bold" }, children: [Mi.formatPrice(B2, { ...A3, metricType: Mt.pnl, showSign: true }), " ", "(", Mi.formatPrice(Q3, { ...A3, useCurrency: false, unit: "%", maximumFractionDigits: 2, showSign: true }), ")"] })] }), void 0 !== J2.v && jsxRuntimeExports.jsxs("div", { style: { fontSize: g3 ? 10 : 11, opacity: a3 ? 0.88 : 0.8, marginTop: g3 ? 2 : 4 }, children: [ri("volume", e3), ":", " ", Mi.formatPrice(J2.v, { ...A3, numberNotation: xt.compact })] })] });
  })() })] });
}), $i = lt.canvas`
    display: block;
    width: 100%;
...
const TQ = reactExports.forwardRef(({ intervalsArray: A2, numberOfYTicks: e2, timeDetailLevel: r2, timeFormat12h: a2, selectedIndex: Q2, setSelectedIndex: g2, chartOptions: E2, showTopBar: d2 = true, showLeftBar: u2 = true, handleChartTypeChange: f2, openSettingsMenu: v2, showSettingsBar: h2, onRefreshRequest: m2, onToggleTheme: b2, symbol: w2, defaultSymbol: y2, onSymbolChange: P2, onSymbolSearch: V2, interval: x2, onIntervalChange: z2, range: X2, onRangeChange: M2, initialRange: O2, onIntervalSearch: q2, themeVariant: H2 = ft.dark, showBrandWatermark: W2 = true, isPrimeLicensed: D2 = false }, F2) => {
  ...
  }(), Y2 = !D2, G2 = reactExports.useCallback((A3) => Y2 ? A3.slice(-2e3) : A3, [Y2]), [k2, U2] = reactExports.useState(() => G2(A2)), Z2 = reactExports.useRef(G2(A2)), L2 = reactExports.useRef(null), R2 = reactExports.useRef(null), S2 = reactExports.useRef(0), [J2, $2] = i.useState({ start: 0, end: 0, startIndex: 0, endIndex: 0 }), [_2, AA2] = i.useState({ min: Math.min(...A2.map((A3) => (null == A3 ? void 0 : A3.l) || 0)), max: Math.max(...A2.map((A3) => (null == A3 ? void 0 : A3.h) || 0)), range: Math.max(...A2.map((A3) => (null == A3 ? void 0 : A3.h) || 0)) - Math.min(...A2.map((A3) => (null == A3 ? void 0 : A3.l) || 0)) }), [eA2, tA2] = reactExports.useState([]), [nA2, rA2] = reactExports.useState({ isOpen: false, title: "", message: "" }), [iA2, aA2] = reactExports.useState(false), [BA2, QA2] = reactExports.useState(null), oA2 = reactExports.useRef(null), gA2 = reactExports.useRef(null), EA2 = reactExports.useRef(null), sA2 = reactExports.useRef(false);
  reactExports.useEffect(() => {
    Z2.current = k2;
  }, [k2]);
  ...
  const uA2 = reactExports.useCallback(() => {
    ...
    var A3, e3;
    const t2 = E2.base.style.backgroundColor, n2 = (void 0 !== w2 ? String(w2).trim() : "") || (null == (e3 = null == (A3 = EA2.current) ? void 0 : A3.value) ? void 0 : e3.trim()) || "unknown", r3 = FQ(k2, 60), i2 = { symbol: n2, visibleTimeStartSec: J2.start, visibleTimeEndSec: J2.end, intervalSeconds: r3, chartType: String(E2.base.chartType ?? "chart"), barsInView: k2.length > 0 ? Math.max(0, J2.endIndex - J2.startIndex + 1) : 0, totalBarsInSeries: k2.length, visiblePriceMin: _2.min, visiblePriceMax: _2.max, capturedAtMs: Date.now() }, a3 = $B(gA2.current, t2, { meta: i2, footerTextColor: E2.base.style.axes.textColor });
    if (a3) try {
      const A4 = document.createElement("a");
  ...
  }, getVisibleRanges: () => ({ time: { start: J2.start, end: J2.end, startIndex: J2.startIndex, endIndex: J2.endIndex }, price: { min: _2.min, max: _2.max, range: _2.range } }), getDrawings: (A3) => VQ(eA2, A3), getDrawingById(A3) {
    const e3 = eA2.findIndex((e4) => e4.id === A3);
    return e3 < 0 ? null : yQ(eA2[e3], e3);
  }, getDrawingInstances: (A3) => xQ(eA2, A3), getSelectedDrawing: () => null == Q2 || Q2 < 0 || Q2 >= eA2.length ? null : yQ(eA2[Q2], Q2), getSelectedDrawingId: () => null == Q2 || Q2 < 0 || Q2 >= eA2.length ? null : eA2[Q2].id, selectShape(A3) {
    var e3, t2;
  ...
  return jsxRuntimeExports.jsxs(ga, { ref: T2, className: "tickup-stage", $showTopBar: d2, $showLeftBar: u2, $showSymbolStrip: zA2, $showRangeSelector: d2, children: [d2 && jsxRuntimeExports.jsx(sa, { className: "top-toolbar-cell", children: jsxRuntimeExports.jsx(fQ, { handleChartTypeChange: f2, selectedChartType: E2.base.chartType, openSettingsMenu: v2, showSettingsBar: h2, language: E2.base.style.axes.language, locale: E2.base.style.axes.locale, symbolInputRef: EA2, symbol: w2, defaultSymbol: y2, onSymbolChange: P2, onSymbolSearch: V2, onFitVisibleRange: fA2, onExportDataCsv: vA2, onSnapshotPng: hA2, onRefresh: mA2, onToggleTheme: b2, themeVariant: H2, interval: x2, onIntervalChange: z2, onIntervalSearch: q2, primeGlass: XA2, primeGlassLight: MA2 }) }), !d2 && zA2 ? jsxRuntimeExports.jsx(Ea, { className: "tickup-compact-symbol-strip", style: { padding: "6px 12px", font: E2.base.style.axes.font, fontWeight: 700, color: E2.base.style.axes.textColor, backgroundColor: E2.base.style.backgroundColor, borderBottom: `1px solid ${E2.base.style.axes.lineColor}` }, role: "status", "aria-label": `Symbol ${xA2}`, children: xA2 }) : null, u2 && jsxRuntimeExports.jsx(la, { className: "side-toolbar-cell", children: jsxRuntimeExports.jsx(TB, { language: E2.base.style.axes.language, locale: E2.base.style.axes.locale, primeGlass: XA2, primeGlassLight: MA2 }) }), jsxRuntimeExports.jsxs(da, { ref: gA2, className: "chart-main-cell tickup-chart-snapshot-root", $yAxisWidth: vt.INITIAL_Y_AXIS_WIDTH, $xAxisHeight: vt.INITIAL_X_AXIS_HEIGHT, $yAxisPosition: E2.axes.yAxisPosition, children: [jsxRuntimeExports.jsx(ca, { className: E2.axes.yAxisPosition === It.left ? "left-y-axis-container" : "right-y-axis-container", $yAxisPosition: E2.axes.yAxisPosition, style: { width: `${vt.INITIAL_Y_AXIS_WIDTH}px` }, children: jsxRuntimeExports.jsx(oa, { yAxisPosition: E2.axes.yAxisPosition, xAxisHeight: vt.INITIAL_X_AXIS_HEIGHT, minPrice: _2.min, maxPrice: _2.max, numberOfYTicks: e2, formatting: E2.base.style.axes }) }), jsxRuntimeExports.jsxs(Ca, { className: "canvas-axis-container", $yAxisPosition: E2.axes.yAxisPosition, children: [!d2 && h2 && jsxRuntimeExports.jsx(fa, { $yAxisPosition: E2.axes.yAxisPosition, onClick: v2, className: "floating-settings-btn", children: jsxRuntimeExports.jsx($a, {}) }), jsxRuntimeExports.jsx(ua, { ref: N2, className: "canvas-container", children: (null == K2 ? void 0 : K2.width) > 0 && (null == K2 ? void 0 : K2.height) > 0 && jsxRuntimeExports.jsx(Ji, { ref: oA2, intervalsArray: k2, drawings: eA2, setDrawings: tA2, selectedIndex: Q2, setSelectedIndex: g2, onRequestShapeProperties: dA2, visibleRange: J2, setVisibleRange: pA2, visiblePriceRange: _2, chartOptions: E2, canvasSizes: K2, windowSpread: vt, showBrandWatermark: W2, isPrimeLicensed: D2, brandTheme: E2.base.theme }) }), jsxRuntimeExports.jsx(Ia, { className: "x-axis-container", children: jsxRuntimeExports.jsx(Ba, { canvasSizes: K2, parentContainerRef: T2, timeDetailLevel: r2, timeFormat12h: a2, formatting: E2.base.style.axes, visibleRange: J2, xAxisHeight: vt.INITIAL_X_AXIS_HEIGHT, dateFormat: E2.base.style.axes.dateFormat || "MMM d", locale: E2.base.style.axes.locale || "en-US", timezone: E2.base.style.axes.timezone }) })] })] }), d2 && jsxRuntimeExports.jsx(bQ, { onRangeChange: VA2, currentRange: yA2, isDark: E2.base.theme === ft.dark }), jsxRuntimeExports.jsx(lB, { isOpen: Boolean(IA2), shape: IA2, onClose: CA2, onApply: cA2, themeVariant: H2 }), jsxRuntimeExports.jsx(cQ, { isOpen: nA2.isOpen, onClose: () => rA2((A3) => ({ ...A3, isOpen: false })), title: nA2.title, message: nA2.message, themeVariant: H2 })] });
});
...
const eo = reactExports.forwardRef((A2, e2) => {
  const { intervalsArray: r2 = [], initialNumberOfYTicks: i2 = 5, initialTimeDetailLevel: a2 = yt.Auto, initialTimeFormat12h: Q2 = false, chartOptions: g2 = JQ, showSidebar: E2, showTopBar: d2, showSettingsBar: C2, onRefreshRequest: I2, symbol: u2, defaultSymbol: f2, onSymbolChange: v2, onSymbolSearch: h2, productId: p2, licenseKey: b2, licenseUserIdentifier: w2, licenseValidationOverride: y2, showAttribution: P2 = true, themeVariant: V2, defaultThemeVariant: x2 = ft.light, onThemeVariantChange: z2, interval: X2, onIntervalChange: M2, range: O2, onRangeChange: q2, initialRange: H2, onIntervalSearch: W2 } = A2, D2 = null != p2, F2 = Ao(p2), j2 = D2 ? F2.showSidebar : E2 ?? F2.showSidebar, T2 = D2 ? F2.showTopBar : d2 ?? F2.showTopBar, N2 = D2 ? F2.showSettingsBar : C2 ?? F2.showSettingsBar, [K2, Y2] = reactExports.useState(() => Cn(RQ, g2)), [G2, k2] = reactExports.useState(x2), U2 = void 0 !== V2, Z2 = U2 ? V2 : G2, [L2, R2] = reactExports.useState(null), S2 = reactExports.useRef(null), [J2, $2] = reactExports.useState(false), [_2, AA2] = reactExports.useState({ isOpen: false, title: "", message: "" }), [eA2, tA2] = reactExports.useState(null), [nA2, rA2] = reactExports.useState(null), iA2 = reactExports.useRef(null), [aA2, BA2] = reactExports.useState({ showSidebar: j2, showTopBar: T2, showSettingsBar: N2, timeFormat12h: Q2 }), QA2 = reactExports.useRef(g2), oA2 = p2 === SQ.prime && true === eA2, gA2 = !oA2, EA2 = !oA2 || P2, sA2 = () => {
  ...
  reactExports.useEffect(() => () => {
    ...
    let A3 = false;
    if (p2 !== SQ.prime) return tA2(null), () => {
      A3 = true;
    };
    ...
    kQ(g2, QA2.current) || (QA2.current = g2, Y2((A3) => {
      const e3 = Cn(A3, g2);
      if (gA2) {
        const t2 = $Q(e3), n2 = _Q(e3);
        return t2 > 3 && n2.wasCapped && sA2(), kQ(n2.options, A3) ? A3 : n2.options;
      }
    ...
    gA2 && Y2((A3) => {
      const e3 = $Q(A3), t2 = _Q(A3);
      return e3 > 3 && t2.wasCapped && sA2(), kQ(t2.options, A3) ? A3 : t2.options;
    });
  }, [gA2]), reactExports.useEffect(() => {
    if (D2) {
      const A4 = Ao(p2);
    ...
    const A3 = (A4) => {
      ...
      if (n2) {
        const t3 = Mi.parseInput(n2, K2.base.style.axes);
  ...
  }, symbol: u2, defaultSymbol: f2, onSymbolChange: v2, onSymbolSearch: h2, interval: X2, onIntervalChange: M2, onIntervalSearch: W2, range: O2, onRangeChange: q2, initialRange: H2, themeVariant: Z2, showBrandWatermark: EA2, isPrimeLicensed: oA2 }), jsxRuntimeExports.jsx(GQ, { isOpen: J2, onClose: () => $2(false), onSave: (A3) => {
  ...
  }, initialSettings: lA2, themeVariant: Z2, lockToolbarLayout: D2, contained: true }), jsxRuntimeExports.jsx(cQ, { isOpen: _2.isOpen, onClose: () => AA2((A3) => ({ ...A3, isOpen: false })), title: _2.title, message: _2.message, themeVariant: Z2 }), nA2 ? jsxRuntimeExports.jsx("div", { style: { position: "absolute", left: "50%", bottom: 16, transform: "translateX(-50%)", zIndex: 90, maxWidth: 560, borderRadius: 10, border: "1px solid rgba(245, 158, 11, 0.35)", background: Z2 === ft.dark ? "rgba(17, 24, 39, 0.95)" : "rgba(15, 23, 42, 0.92)", color: "#fbbf24", padding: "10px 12px", fontSize: 12, fontFamily: "system-ui, sans-serif", textAlign: "center", pointerEvents: "none" }, children: nA2 }) : null] })] })] });
}), to = reactExports.forwardRef((A2, e2) => jsxRuntimeExports.jsx(eo, { ref: e2, productId: SQ.pulse, ...A2 })), no = reactExports.forwardRef((A2, e2) => jsxRuntimeExports.jsx(eo, { ref: e2, productId: SQ.flow, ...A2 })), ro = reactExports.forwardRef((A2, e2) => jsxRuntimeExports.jsx(eo, { ref: e2, productId: SQ.command, ...A2 })), io = reactExports.forwardRef((A2, e2) => jsxRuntimeExports.jsx(eo, { ref: e2, productId: SQ.desk, ...A2 })), ao = reactExports.forwardRef((A2, e2) => jsxRuntimeExports.jsx(eo, { ref: e2, productId: SQ.prime, ...A2 }));
to.displayName = "TickUpPulse", no.displayName = "TickUpFlow", ro.displayName = "TickUpCommand", io.displayName = "TickUpDesk", ao.displayName = "TickUpPrimeTier";
lt.div`
...
export { It as I, Nt as N, Pt as P, Vt as V, Yt as Y, __vitePreload as _, ao as a, rn as b, eo as e, ft as f, io as i, no as n, ro as r, to as t, v, yt as y, zQ as z };
